...
from dtw import dtw
from pyshapeDTW.elastic_measure.derivative_dtw import DerivativeDTW  # Replace with the actual module name
...
def test_init_invalid_sequences():
    ...
    with pytest.raises(ValueError):
        DerivativeDTW(np.random.rand(10, 2), np.random.rand(5, 3))  # Mismatched dimensions
